...
await bunPackageBuilder({
  ...
  define: {
    ...
    ARGUS_TYPESCRIPT_WASM: encodedWasm("./src/languages/typescript/grammar/tree-sitter-typescript.wasm"),
    ARGUS_TSX_WASM: encodedWasm("./src/languages/typescript/grammar/tree-sitter-tsx.wasm"),
  },
